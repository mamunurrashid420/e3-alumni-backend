...
class UpdatePaymentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'payment_purpose' => ['sometimes', 'required', 'string', 'in:ASSOCIATE_MEMBERSHIP_FEES,GENERAL_MEMBERSHIP_FEES,LIFETIME_MEMBERSHIP_FEES,SPECIAL_YEARLY_CONTRIBUTION_EXECUTIVE,DONATIONS,PATRON,OTHERS'],
